...
public class Table<L extends ListItem> extends JTable {
	...
	class CustomRenderer extends DefaultTableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table,
			...
			L rowElement = getModel().getRow(row);
			if (rowElement instanceof ColoredListItem) {
				c.setForeground(((ColoredListItem) rowElement).getColor(column));
			} else {
	...
	class BooleanRenderer extends JCheckBox implements TableCellRenderer,
		...
		public Component getTableCellRendererComponent(JTable table,
			...
			if (isSelected) {
				...
				L rowElement = Table.this.getModel().getRow(row);
				if (rowElement instanceof ColoredListItem) {
					setForeground(((ColoredListItem) rowElement)
							.getColor(column));
